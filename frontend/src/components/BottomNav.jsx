...
const TABS = [
  ...
  { key: 'plans',     path: '/plans',     label: '광고 제거', icon: 'M12 3l1.9 4.6L18.5 9l-4.6 1.4L12 15l-1.9-4.6L5.5 9l4.6-1.4L12 3z M12 15v6' },
...
export default function BottomNav({ onHome }) {
  ...
  function activeKey() {
    ...
    if (p.startsWith('/shadowing')) return 'shadowing'
