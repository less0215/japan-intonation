...
export const VERBS = [
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    conjugations: {
      formal: [
        { text: '言います',             ruby: '이이마스',        meaning: '말합니다' },
        { text: '言いません',           ruby: '이이마셍',        meaning: '안 말합니다' },
        { text: '言いますか？',         ruby: '이이마스까?',     meaning: '말합니까?' },
        { text: '言いませんか？',       ruby: '이이마셍까?',     meaning: '안 말합니까?' },
        { text: '言いました',           ruby: '이이마시타',      meaning: '말했습니다' },
        { text: '言いませんでした',     ruby: '이이마셍데시타',  meaning: '안 말했습니다' },
        { text: '言いましたか？',       ruby: '이이마시타까?',   meaning: '말했습니까?' },
        { text: '言いませんでしたか？', ruby: '이이마셍데시타까?', meaning: '안 말했습니까?' },
      ],
      casual: [
        { text: '言う',           ruby: '이우',        meaning: '말해' },
        { text: '言わない',       ruby: '이와나이',    meaning: '안 말해' },
        { text: '言う？',         ruby: '이우?',       meaning: '말해?' },
        { text: '言わない？',     ruby: '이와나이?',   meaning: '안 말해?' },
        { text: '言った',         ruby: '잇타',        meaning: '말했어' },
        { text: '言わなかった',   ruby: '이와나캇타',  meaning: '안 말했어' },
        { text: '言った？',       ruby: '잇타?',       meaning: '말했어?' },
        { text: '言わなかった？', ruby: '이와나캇타?', meaning: '안 말했어?' },
      ],
    },
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    conjugations: {
      formal: [
        { text: '思います',             ruby: '오모이마스',        meaning: '생각합니다' },
        { text: '思いません',           ruby: '오모이마셍',        meaning: '생각 안 합니다' },
        { text: '思いますか？',         ruby: '오모이마스까?',     meaning: '생각하십니까?' },
        { text: '思いませんか？',       ruby: '오모이마셍까?',     meaning: '생각 안 하십니까?' },
        { text: '思いました',           ruby: '오모이마시타',      meaning: '생각했습니다' },
        { text: '思いませんでした',     ruby: '오모이마셍데시타',  meaning: '생각 안 했습니다' },
        { text: '思いましたか？',       ruby: '오모이마시타까?',   meaning: '생각했습니까?' },
        { text: '思いませんでしたか？', ruby: '오모이마셍데시타까?', meaning: '생각 안 했습니까?' },
      ],
      casual: [
        { text: '思う',           ruby: '오모우',      meaning: '생각해' },
        { text: '思わない',       ruby: '오모와나이',  meaning: '생각 안 해' },
        { text: '思う？',         ruby: '오모우?',     meaning: '생각해?' },
        { text: '思わない？',     ruby: '오모와나이?', meaning: '생각 안 해?' },
        { text: '思った',         ruby: '오못타',      meaning: '생각했어' },
        { text: '思わなかった',   ruby: '오모와나캇타', meaning: '생각 안 했어' },
        { text: '思った？',       ruby: '오못타?',     meaning: '생각했어?' },
        { text: '思わなかった？', ruby: '오모와나캇타?', meaning: '생각 안 했어?' },
      ],
    },
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    conjugations: {
      formal: [
        { text: '行きます',             ruby: '이키마스',        meaning: '갑니다' },
        { text: '行きません',           ruby: '이키마셍',        meaning: '안 갑니다' },
        { text: '行きますか？',         ruby: '이키마스까?',     meaning: '갑니까?' },
        { text: '行きませんか？',       ruby: '이키마셍까?',     meaning: '안 가십니까?' },
        { text: '行きました',           ruby: '이키마시타',      meaning: '갔습니다' },
        { text: '行きませんでした',     ruby: '이키마셍데시타',  meaning: '안 갔습니다' },
        { text: '行きましたか？',       ruby: '이키마시타까?',   meaning: '갔습니까?' },
        { text: '行きませんでしたか？', ruby: '이키마셍데시타까?', meaning: '안 갔습니까?' },
      ],
      casual: [
        { text: '行く',           ruby: '이쿠',      meaning: '가' },
        { text: '行かない',       ruby: '이카나이',  meaning: '안 가' },
        { text: '行く？',         ruby: '이쿠?',     meaning: '가?' },
        { text: '行かない？',     ruby: '이카나이?', meaning: '안 가?' },
        { text: '行った',         ruby: '잇타',      meaning: '갔어' },
        { text: '行かなかった',   ruby: '이카나캇타', meaning: '안 갔어' },
        { text: '行った？',       ruby: '잇타?',     meaning: '갔어?' },
        { text: '行かなかった？', ruby: '이카나캇타?', meaning: '안 갔어?' },
      ],
    },
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    conjugations: {
      formal: [
        { text: '来ます',             ruby: '키마스',        meaning: '옵니다' },
        { text: '来ません',           ruby: '키마셍',        meaning: '안 옵니다' },
        { text: '来ますか？',         ruby: '키마스까?',     meaning: '옵니까?' },
        { text: '来ませんか？',       ruby: '키마셍까?',     meaning: '안 오십니까?' },
        { text: '来ました',           ruby: '키마시타',      meaning: '왔습니다' },
        { text: '来ませんでした',     ruby: '키마셍데시타',  meaning: '안 왔습니다' },
        { text: '来ましたか？',       ruby: '키마시타까?',   meaning: '왔습니까?' },
        { text: '来ませんでしたか？', ruby: '키마셍데시타까?', meaning: '안 왔습니까?' },
      ],
      casual: [
        { text: '来る',           ruby: '쿠루',      meaning: '와' },
        { text: '来ない',         ruby: '코나이',    meaning: '안 와' },
        { text: '来る？',         ruby: '쿠루?',     meaning: '와?' },
        { text: '来ない？',       ruby: '코나이?',   meaning: '안 와?' },
        { text: '来た',           ruby: '키타',      meaning: '왔어' },
        { text: '来なかった',     ruby: '코나캇타',  meaning: '안 왔어' },
        { text: '来た？',         ruby: '키타?',     meaning: '왔어?' },
        { text: '来なかった？',   ruby: '코나캇타?', meaning: '안 왔어?' },
      ],
    },
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    conjugations: {
      formal: [
        { text: '見ます',             ruby: '미마스',        meaning: '봅니다' },
        { text: '見ません',           ruby: '미마셍',        meaning: '안 봅니다' },
        { text: '見ますか？',         ruby: '미마스까?',     meaning: '봅니까?' },
        { text: '見ませんか？',       ruby: '미마셍까?',     meaning: '안 보십니까?' },
        { text: '見ました',           ruby: '미마시타',      meaning: '봤습니다' },
        { text: '見ませんでした',     ruby: '미마셍데시타',  meaning: '안 봤습니다' },
        { text: '見ましたか？',       ruby: '미마시타까?',   meaning: '봤습니까?' },
        { text: '見ませんでしたか？', ruby: '미마셍데시타까?', meaning: '안 봤습니까?' },
      ],
      casual: [
        { text: '見る',           ruby: '미루',      meaning: '봐' },
        { text: '見ない',         ruby: '미나이',    meaning: '안 봐' },
        { text: '見る？',         ruby: '미루?',     meaning: '봐?' },
        { text: '見ない？',       ruby: '미나이?',   meaning: '안 봐?' },
        { text: '見た',           ruby: '미타',      meaning: '봤어' },
        { text: '見なかった',     ruby: '미나캇타',  meaning: '안 봤어' },
        { text: '見た？',         ruby: '미타?',     meaning: '봤어?' },
        { text: '見なかった？',   ruby: '미나캇타?', meaning: '안 봤어?' },
      ],
    },
